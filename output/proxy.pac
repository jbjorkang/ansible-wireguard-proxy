function FindProxyForURL(url, host) {
  if (shExpMatch(host, "*.se"))
    ...
    return "SOCKS5 gb22-wg.socks5.mullvad.net:1080;" + "SOCKS5 gb23-wg.socks5.mullvad.net:1080;" + "SOCKS5 gb24-wg.socks5.mullvad.net:1080;" + "SOCKS5 gb17-wg.socks5.mullvad.net:1080" ; 
  else
  return "DIRECT";
}
